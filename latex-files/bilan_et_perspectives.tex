...
CloudWatch, Grafana) et en ingénierie de fiabilité (méthodes RED et USE, notions de MTTD, MTTR,
watchdog). Au-delà de la technique, j'ai appris à conduire un projet dans un environnement de
...
\begin{table}[h]
	...
	\begin{tabular}{|p{0.3\textwidth}|p{0.6\textwidth}|}
		...
		\hline
		Administration \& exploitation & Watchdog, mode dégradé, gestion du cycle de vie des alertes ; missions de fast (provisionnement, réseau, Puppet). \\
		\hline
