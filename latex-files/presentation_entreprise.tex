...
2018 et paris sportifs en 2020, lancement des paris sportifs en Allemagne en 2021, puis lancement plus récent des paris sportifs en Italie.
Prévisionnellement, Winamax prévoit de s'implanter au Portugal et d'ouvrir un casino en ligne en Espagne cette année.
...
\begin{itemize}
	...
	\item \textbf{l’équipe Poker Data} : s’occupe du stockage, du traitement et de l’analyse des données de poker. Elle développe des outils pour le monitoring, le reporting réglementaire (comme pour la DGOJ) et la détection de la fraude.
	...
	\item \textbf{l’équipe Infrastructure} : garantit la fiabilité et le bon fonctionnement de l’infrastructure cloud, hébergée sur AWS. Elle effectue des tâches liées au SRE et au DevOps, gère le scaling, l’observabilité et la résilience des services.
