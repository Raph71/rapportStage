...
AWS et à généraliser l'Infrastructure as Code (IaC), notamment via CloudFormation, Terraform et
Puppet.
...
L'activité de Winamax est soumise à une régulation stricte : l'agrément délivré par l'ANJ \cite{anj} impose des
