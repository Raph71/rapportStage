...
\begin{itemize}
	...
	\item \textbf{l’équipe Infrastructure} : garantit la fiabilité et le bon fonctionnement de l’infrastructure cloud, hébergée sur AWS. Elle effectue des tâches liées au SRE et au DevOps, gère la montée en charge (\emph{scaling}), l’observabilité et la résilience des services.
...
décrit en code et versionné — l'Infrastructure as Code (IaC), généralisée via Terraform —, automatisé,
et surtout mesuré grâce à une observabilité poussée. Celle-ci repose sur les trois piliers du SRE : les
métriques (Prometheus), les logs et les traces distribuées (OpenTelemetry et Jaeger), l'ensemble étant
...
\begin{itemize}
	...
	\item Déploiement des outils communs : Grafana, Prometheus, Jaeger ;
	\item Gestion de la stack d'observabilité : collecte des métriques, des logs et des traces distribuées ;
