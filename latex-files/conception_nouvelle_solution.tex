...
En dehors de la production (environnements de développement et de pré-production), même une alerte
P1 ne doit pas déranger l'astreinte : un simple message est envoyé sur le canal Slack dédié à l'équipe
...
Chaque alerte est en outre associée à un runbook — une fiche décrivant la marche à suivre pour
diagnostiquer et résoudre le problème — comprenant un lien direct vers le tableau de bord (dashboard)
Grafana du service concerné. Ce tableau de bord offre une visualisation détaillée permettant d'identifier
