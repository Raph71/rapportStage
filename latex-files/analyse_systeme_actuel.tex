...
s'exécutent dans des conteneurs regroupés au sein de clusters ECS (\emph{Elastic Container Service}, le
...
serveur à gérer) qui créent ou suppriment des alarmes dans CloudWatch, l'outil de surveillance d'\lexique{AWS}.
Enfin, les alarmes déclenchées émettent des notifications qui, via un service de messagerie (un topic
SNS puis une file d'attente SQS), aboutissent sur les canaux de diffusion, principalement Slack.
